...
|--------------------|---------------------|---------------------|--------------|--------------------------------|----------------------------------------------------------|
| auto_explain       | -                   | -                   | O            | Require SUPERUSER permission if running `LOAD` syntax | https://www.postgresql.org/docs/17/auto-explain.html     |
...
| earthdistance      | 1.1                 | 1.2                 | O            | Require cube installation                     | https://www.postgresql.org/docs/17/earthdistance.html    |
