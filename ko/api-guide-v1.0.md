...
| dbInstances.dbInstanceType   | Body | Enum     | DB 인스턴스의 역할 유형<br/>- `MASTER`: 마스터<br/>- `READ_ONLY_SLAVE`: 읽기 복제본 |
...
| dbInstanceType            | Body | Enum     | DB 인스턴스의 역할 유형<br/>- `MASTER`: 마스터<br/>- `READ_ONLY_SLAVE`: 읽기 복제본 |
